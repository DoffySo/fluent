                ...
                <div className="chatitem-container w-full h-full flex my-auto">
                    ...
                    <div className="content-container w-full h-18 border-b border-accent flex flex-col overflow-x-hidden text-ellipsis">
                        <div className="heading flex">
                            <div className="heading__title text-foreground overflow-x-hidden text-ellipsis">
                        ...
                        <div className="subheading flex justify-between pb-px h-full">
                            <div className="subheading-left flex flex-col w-full">
                                <div className="subheading__text w-full text-muted-foreground overflow-x-hidden text-ellipsis">
                                ...
                                <div className="subheading__folder w-fit flex gap-1 flex-nowrap">
                                    {
                                        folders.map((folder, index) =>
                                            <div
                                                key={index}
                                                className="badge text-xs font-medium text-indigo-600 bg-indigo-400/20 px-1 py-0.5 rounded-sm">
                                                {folder}
                                            </div>)
                                    }
                                </div>
